...
const CppIntroSection = () => {
  return (
    <div className="px-6 py-12 max-w-6xl mx-auto">
      <h1 className="text-4xl font-bold text-purple-700 mb-8">🔰 C++ Programming – Introduction & Basics</h1>

      {/* Theory Card */}
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-6 mb-8">
        <h2 className="text-2xl font-semibold text-purple-600 mb-4">📘 What is C++?</h2>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-6 mb-8">
        <h2 className="text-2xl font-semibold text-purple-600 mb-4">🧱 Structure of a C++ Program</h2>
      ...
      {/* Code Example Card */}
      <div className="bg-gray-100 dark:bg-gray-800 rounded-2xl shadow-lg p-6 mb-8">
        <h2 className="text-2xl font-semibold text-purple-600 mb-4">🖥️ Hello World Example</h2>
...
int main() {
    ...
    return 0;
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-6 mb-8">
        <h2 className="text-2xl font-semibold text-purple-600 mb-4">🎯 Interview Questions</h2>
      ...
      <section className="bg-white dark:bg-gray-800 shadow-lg rounded-2xl p-6 mb-6">
        <h2 className="text-2xl font-semibold text-purple-600 mb-2">✅ Conditional Statements</h2>
...
if (age >= 18) {
    ...
    cout << "Not eligible";
      ...
      {/* Theory Card */}
      <div className="bg-white dark:bg-gray-900 shadow-md rounded-xl p-6 mb-8">
        <h2 className="text-2xl font-semibold text-purple-600 mb-3">📘 Theory</h2>
        <p className="text-lg leading-relaxed mb-4">
      ...
      {/* Code Example Card */}
      <div className="bg-white dark:bg-gray-900 shadow-md rounded-xl p-6 mb-8">
        <h2 className="text-2xl font-semibold text-purple-600 mb-3">💻 Code Example</h2>
...
int main() {
    ...
    return 0;
      ...
      {/* Interview Questions Card */}
      <div className="bg-white dark:bg-gray-900 shadow-md rounded-xl p-6 mb-8">
        <h2 className="text-2xl font-semibold text-purple-600 mb-3">🎯 Interview Questions</h2>
      ...
      {/* Loops */}
      <section className="bg-white dark:bg-gray-800 shadow-lg rounded-2xl p-6 mb-6">
        <h2 className="text-2xl font-semibold text-purple-600 mb-2">🔁 Loops in C++</h2>
...
do {
    ...
    i++;
      ...
      {/* Switch Statement */}
      <section className="bg-white dark:bg-gray-800 shadow-lg rounded-2xl p-6 mb-6">
        <h2 className="text-2xl font-semibold text-purple-600 mb-2">🔘 Switch Statement</h2>
        <p className="text-lg leading-relaxed mb-4">
...
// Output: Wednesday`}
      ...
      {/* Tips Card */}
      <section className="bg-gradient-to-r from-purple-100 to-purple-200 dark:from-gray-700 dark:to-gray-800 rounded-2xl p-6 shadow mb-6">
        <h3 className="text-xl font-semibold text-purple-700 mb-2">💡 Tips & Tricks</h3>
      ...
      <section className="bg-gradient-to-r from-pink-100 to-purple-100 dark:from-gray-700 dark:to-gray-800 rounded-2xl p-6 shadow mb-6">
        <h3 className="text-xl font-semibold text-purple-700 mb-2">📝 Practice Questions</h3>
      ...
      {/* Interview Questions */}
      <section className="bg-white dark:bg-gray-800 shadow-lg rounded-2xl p-6 mb-6">
        <h3 className="text-xl font-semibold text-purple-600 mb-2">📌 Interview Questions</h3>
      ...
      {/* Conclusion */}
      <section className="bg-purple-100 dark:bg-gray-900 rounded-2xl p-6 shadow-lg">
        <h3 className="text-xl font-semibold text-purple-700 mb-2">🔚 Conclusion</h3>
        <p className="text-lg">
...
// File: CppFunctionsArrays.jsx
      {/* 📘 Theory */}
      <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl shadow-md mb-6">
      ...
      <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl shadow-md mb-6">
        ...
        <h3 className="text-xl font-medium text-purple-500">➡️ User-defined Function</h3>
...
int main() {
    ...
    return 0;
        ...
        <h3 className="text-xl font-medium text-purple-500">➡️ Array Example</h3>
...
int main() {
  ...
  <section className="mb-12">
        ...
        <div className="bg-white dark:bg-gray-800 shadow-md rounded-xl p-6 mb-6">
          ...
          <p className="text-lg mt-4 text-gray-800 dark:text-gray-100">
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-purple-700 mb-4">🚀 Advanced C++ Topics (Quick Glance)</h2>
        <div className="grid md:grid-cols-2 gap-6">
          {[
            ...
            <div key={idx} className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-md">
              <h4 className="text-xl font-semibold text-purple-600 mb-2">{item.title}</h4>
              <p className="text-gray-700 dark:text-gray-100">{item.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-purple-700 mb-4">🎯 C++ Interview Questions</h2>
        <div className="grid md:grid-cols-2 gap-6">
          {[
            ...
            <div key={i} className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-md">
              <h4 className="text-lg font-semibold text-purple-600 mb-2">Q{i + 1}.</h4>
              <p className="text-gray-700 dark:text-gray-100">{q}</p>
            </div>
          ))}
        </div>
      </section>
