...
const examples = [
  ...
  return (
    <div className="px-6 py-12 max-w-6xl mx-auto">
      <h1 className="text-4xl font-bold text-purple-700 mb-6">💻 Operating System: Theory Section</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {theoryCards.map((card, idx) => (
          <div
            key={idx}
            className="bg-white dark:bg-gray-900 rounded-2xl shadow-md p-6 border border-purple-200 dark:border-purple-700 hover:shadow-lg transition duration-300"
          >
            <h2 className="text-xl font-semibold text-purple-600 mb-2">{card.title}</h2>
            <p className="text-gray-800 dark:text-gray-300 text-base leading-relaxed">{card.content}</p>
          </div>
        ))}
      </div>
      {/* Examples Section */}
      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-purple-600 mb-4">🧪 Real-World Examples & Use Cases</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {examples.map((ex, i) => (
            <div
              key={i}
              className="bg-white dark:bg-gray-900 border border-purple-300 dark:border-purple-700 rounded-2xl p-5 shadow-md hover:shadow-lg transition"
            >
              <h3 className="text-xl font-semibold text-purple-500 mb-2">{ex.title}</h3>
              <p className="text-gray-800 dark:text-gray-300 leading-relaxed">{ex.content}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="mb-12 card">
        <h2 className="text-2xl font-semibold text-purple-600 mb-4">🧠 Top OS Interview Questions</h2>
        <ul className="space-y-3 text-gray-800 dark:text-gray-300 list-disc pl-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-zinc-900 rounded-2xl p-6 shadow-md border-l-4 border-purple-500">
          <h2 className="text-xl font-semibold text-purple-600 mb-2">📘 What is an Operating System?</h2>
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl p-6 shadow-md border-l-4 border-indigo-500">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl p-6 shadow-md border-l-4 border-pink-500">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl p-6 shadow-md border-l-4 border-blue-500">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl p-6 shadow-md border-l-4 border-green-500">
      ...
      {/* Examples Section */}
      <div className="bg-violet-100 dark:bg-zinc-800 rounded-2xl p-6 shadow-md border-l-4 border-violet-500">
      ...
      {/* Tips & Tricks */}
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-yellow-100 dark:bg-zinc-800 rounded-2xl p-6 shadow-md border-l-4 border-yellow-500">
        ...
        <div className="bg-rose-100 dark:bg-zinc-800 rounded-2xl p-6 shadow-md border-l-4 border-rose-500">
      ...
      {/* Interview Questions */}
      <div className="bg-blue-50 dark:bg-zinc-900 rounded-2xl p-6 shadow-md border-l-4 border-blue-600">
        <h2 className="text-2xl font-bold text-blue-700 mb-4">💬 Interview Questions</h2>
        <ul className="list-decimal ml-6 space-y-2 text-gray-800 dark:text-gray-100">
      ...
      {/* Conclusion */}
      <div className="bg-green-50 dark:bg-zinc-800 rounded-2xl p-6 shadow-md border-l-4 border-green-600">
