...
const AndroidDevelopment = () => {
  return (
    <div className="px-6 py-12 max-w-6xl mx-auto text-left">
      <h1 className="text-4xl font-bold text-purple-700 mb-8">📱 Android Development</h1>

      {/* Overview */}
      <div className="grid gap-6 md:grid-cols-2">
        <div className="bg-white dark:bg-zinc-900 shadow-lg rounded-xl p-6 border border-purple-200">
          <h2 className="text-2xl font-semibold text-purple-600 mb-2">📘 What is Android Development?</h2>
          <p className="text-lg">
        ...
        {/* Core Components */}
        <div className="bg-white dark:bg-zinc-900 shadow-lg rounded-xl p-6 border border-purple-200">
          <h2 className="text-2xl font-semibold text-purple-600 mb-2">🧱 Core Components</h2>
        ...
        <div className="bg-white dark:bg-zinc-900 shadow-lg rounded-xl p-6 border border-purple-200 md:col-span-2">
          <h2 className="text-2xl font-semibold text-purple-600 mb-2">🛠️ Setting up Android Studio</h2>
          <p className="text-lg">
        ...
        {/* Example Code */}
        <div className="bg-white dark:bg-zinc-900 shadow-lg rounded-xl p-6 border border-purple-200 md:col-span-2">
          <h2 className="text-2xl font-semibold text-purple-600 mb-2">💡 Sample Kotlin Code</h2>
...
{`class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        {/* Advanced Topics */}
        <div className="bg-white dark:bg-zinc-900 shadow-lg rounded-xl p-6 border border-purple-200">
          <h2 className="text-2xl font-semibold text-purple-600 mb-2">🚀 Advanced Topics</h2>
          <ul className="list-disc pl-5 text-lg space-y-1">
        ...
        {/* Practice Questions */}
        <div className="bg-white dark:bg-zinc-900 shadow-lg rounded-xl p-6 border border-purple-200">
          <h2 className="text-2xl font-semibold text-purple-600 mb-2">📝 Practice Questions</h2>
        ...
        <div className="bg-white dark:bg-zinc-900 shadow-lg rounded-xl p-6 border border-purple-200 md:col-span-2">
          <h2 className="text-2xl font-semibold text-purple-600 mb-2">🎯 Interview Questions + Summary</h2>
          <ul className="list-disc pl-5 text-lg space-y-1">
